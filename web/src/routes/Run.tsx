            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              {run.verdict && (
                <div className="flex flex-col items-end leading-none">
                  <span className="mb-1 flex items-center gap-1 text-[9px] font-semibold uppercase tracking-widest text-muted-foreground">
                    AI Signal
                    <InfoTip side="bottom">
                      The desk's combined verdict on a 5-tier scale: Sell,
                      Underweight, Hold, Overweight, Buy. Generated by the
                      Portfolio Manager after the analysts, the bull/bear
                      debate, the trader, and the three-way risk team have
                      all weighed in. This is research, not advice.
                    </InfoTip>
                  </span>
