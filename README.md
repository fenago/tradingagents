...
- Sentiment Analyst: Reads news headlines (and, when configured, social feeds — Reddit / StockTwits via the optional `sentiment_data` vendor) to gauge short-term market mood. Without a social vendor configured, output is news-derived only.
